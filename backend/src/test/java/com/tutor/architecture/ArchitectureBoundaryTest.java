...
public class ArchitectureBoundaryTest {
    ...
    public static final ArchRule knowledgeDoesNotDependOnChat = noClasses().that().resideInAnyPackage("com.tutor.knowledge..").should().dependOnClassesThat().resideInAnyPackage("com.tutor.chat..");
