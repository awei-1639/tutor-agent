...
class FusedRetrieverSparseTest {
    ...
    void denseAndSparseCandidatesCanExpand() {
        List<com.tutor.knowledge.retrieval.vector.VectorStore.VectorHit> dense = List.of(
                new com.tutor.knowledge.retrieval.vector.VectorStore.VectorHit("dense:1", "skill", "d", 0.9D));
        List<com.tutor.knowledge.retrieval.vector.VectorStore.VectorHit> sparse = List.of(
                new com.tutor.knowledge.retrieval.vector.VectorStore.VectorHit("sparse:rare", "skill", "s", 0.8D));
    ...
    private static com.tutor.knowledge.retrieval.vector.VectorStore.VectorHit hit(String nodeId, double score) {
        return new com.tutor.knowledge.retrieval.vector.VectorStore.VectorHit(nodeId, "skill", nodeId, score);
    }
