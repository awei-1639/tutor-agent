...
class Mem0ClientTest {
    ...
    void dropsResultsWithoutVerifiableUserOwnership() {
        ...
        List<com.tutor.conversation.memory.local.EpisodeStore.Episode> result = client.search(42L, "Java", "trace");

        assertThat(result).extracting(com.tutor.conversation.memory.local.EpisodeStore.Episode::summary)
