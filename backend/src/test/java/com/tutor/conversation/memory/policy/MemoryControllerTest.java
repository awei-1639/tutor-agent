...
class MemoryControllerTest {
    ...
    private MemoryController controller(EpisodeStore store, LongTermMemoryService memory, MemorySyncOutbox outbox) {
        ...
        return new MemoryController(store, memory, outbox, mock(ProfileService.class), mock(ConversationStore.class), mock(com.tutor.conversation.memory.local.FactStore.class), limiter);
    }
}
