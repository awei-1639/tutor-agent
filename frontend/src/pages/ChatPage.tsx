...
export default function ChatPage() {
  ...
  return (
    <div className="h-full flex">
      ...
      <aside className={`${sidebarOpen ? 'w-64' : 'w-0'} shrink-0 border-r border-ink-100 bg-white flex flex-col transition-all overflow-hidden`}>
        <div className="px-4 py-4 border-b border-ink-100 shrink-0">
      ...
      <div className="flex-1 flex flex-col min-w-0"
        ...
        <header className="shrink-0 px-6 py-3 border-b border-ink-100 bg-white flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button onClick={() => setSidebarOpen(o => !o)} className="text-ink-500 hover:text-ink-900 p-1" title={sidebarOpen ? '折叠历史' : '展开历史'}>
