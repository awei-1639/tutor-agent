...
export default function KnowledgeBasePage() {
  ...
  return <div className="h-full overflow-y-auto"><div className="mx-auto max-w-[1240px] px-8 py-8">
    <div className="flex items-start justify-between gap-4 mb-7"><div><div className="editorial-kicker mb-2">Knowledge operations</div><h1 className="font-serif text-[28px] font-semibold tracking-[-.02em] text-ink-900">知识库</h1><p className="mt-2 text-sm leading-6 text-ink-500">原文件保存在私有 OSS，解析、切分和向量化在后台执行；仅已入库文档会参与 RAG 召回。</p></div><button onClick={() => void reload()} className="rounded-lg border border-ink-200 bg-white px-3 py-2 text-sm text-ink-700">刷新</button></div>
